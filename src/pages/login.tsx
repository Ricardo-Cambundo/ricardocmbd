                    ...
                    <div className="info">
                        ...
                        <div className="form">
                            ...
                            <div style={{display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
                                ...
                                <span style={{ borderWidth: 1, borderColor: '#e2e2e2', height: 35, width: 35, display: 'flex', justifyContent: 'center', alignItems: 'center', borderTopRightRadius: 5, borderBottomRightRadius:5, cursor: 'pointer'}}
                                onClick={() => {
                                    setSee(!see)
                                }}>
                                    {
