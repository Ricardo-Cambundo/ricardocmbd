        ...
        <div id="featuredSection" className="blogPage">
          ...
          <div className="content" style={{ color: dark && "white" }}>
            ...
            <ul>
              ...
              <li>
                Scalable backend using Laravel and PostgreSQL to handle high
                traffic and data reliability
              </li>
              <li>
            ...
            <p>
              Provides real-time GPS tracking and live bus location updates,
              ensuring accurate and up-to-date information on bus arrivals. This
              feature helps users monitor bus positions in real-time, enabling
              better planning and improved transportation efficiency through the
              mobile app:
            </p>
            <div
              className={`${dark ? "imageContainer-light" : "imageContainer"}`}
            ...
            <h1>
              2. Personalized notifications via SMS and push alerts for arrival
              times and delays
            </h1>
            <p>
              Offers personalized notifications through SMS and push alerts to
              inform users about bus arrival times, delays, and service updates.
              This feature ensures timely communication, enhancing the user
              experience by keeping passengers informed and allowing for better
              trip planning:
            </p>
            ...
            <h1>
              3. Secure user authentication and personalized profiles for
              seamless access
            </h1>
            <p>
              Implement OTP-based authentication to ensure secure user
              verification and prevent SMS from being sent to wrong numbers.
              Additionally, provide users with the ability to manage and update
              their personal details within their profiles. This combination
              ensures seamless, protected access while maintaining data accuracy
              and privacy:
            </p>
            <div
              className={`${dark ? "imageContainer-light" : "imageContainer"}`}
