...
import pitruca1 from "../../assets/images/pitruca/pitruca1.svg";
import pitruca2 from "../../assets/images/pitruca/pitruca2.svg";
import pitruca3 from "../../assets/images/pitruca/pitruca3.svg";
import pitruca4 from "../../assets/images/pitruca/pitruca4.svg";
import pitruca5 from "../../assets/images/pitruca/pitruca5.svg";
...
const Project10 = () => {
  ...
  const info = {
    title: "PITRUCA",
    preDescription:
      "Official website Angola's biggest educational group with 10k+ monthly visitors.",
    highlight: null,
    warning: null,
    description:
      "The official website for PITRUCA educational group, Angola’s leading educational group with over 10,000 monthly visitors, is built using React.js and Laravel to deliver a fast, reliable, and scalable platform with 99.9% uptime. It features a custom CMS for managing news, academic programs, events, and documents, with role-based access control and automated reminders to keep users engaged and informed. The admin panel provides real-time traffic analytics, geographic and demographic insights, and granular user permissions through JWT authentication, enabling efficient content management and data-driven decision-making. Performance has been optimized through query enhancements and lazy-loading techniques, ensuring a seamless and responsive experience for students, faculty, and visitors",
    read: 4,
    date: "2025-03-03",
    tags: [
      "React",
          ...
          <div className="content" style={{ color: dark && "white" }}>
            ...
            >
              ...
              >
                {" "}
                {/* <img loading="lazy" src={levelinvoice} /> */}
                <img src={pitruca1} className="2pc" />
              </div>
              <div
                className={`${
                  dark ? "imageContainer-light" : "imageContainer"
              ...
              >
                {" "}
                {/* <img loading="lazy" src={levelinvoice} /> */}
                <img src={pitruca2} className="2pc" />
              </div>
            </div>
            ...
            >
              ...
              >
                {" "}
                {/* <img loading="lazy" src={levelinvoice} /> */}
                <img src={pitruca3} className="2pc" />
              </div>
              <div
                className={`${
                  dark ? "imageContainer-light" : "imageContainer"
              ...
              >
                {" "}
                {/* <img loading="lazy" src={levelinvoice} /> */}
                <img src={pitruca4} className="2pc" />
              </div>
            </div>
            ...
            >
              {" "}
              {/* <img loading="lazy" src={levelinvoice} /> */}
              <img src={pitruca5} className="2pc" />
            </div>
            ...
            <footer>
              ...
              <p>
                ...
                hub for the group. If you're interested in seeing more or would
