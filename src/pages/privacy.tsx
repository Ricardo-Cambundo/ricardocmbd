...
const Privacy = () => {
  ...
  <div className="page">
    ...
    <div id="privacySection" style={{color: dark && 'white'}}>
      ...
      <div className={dark ? "sectionTitle1" : "sectionTitle"}>Information I Collect (Not Much, Honestly)</div>
      ...
      <div className={dark ? "sectionTitle1" : "sectionTitle"}>How Your Info Is Used</div>
      ...
      <div className={dark ? "sectionTitle1" : "sectionTitle"}>Sharing Your Data (Spoiler: I Don't)</div>
      ...
      <div className={dark ? "sectionTitle1" : "sectionTitle"}>Data Security (The Internet's Not Perfect)</div>
      ...
      <div className={dark ? "sectionTitle1" : "sectionTitle"}>Policy Changes (No Surprises)</div>
      ...
      color: dark && "white",
                  ...
                  onClick={() => { navigate('/contact') }}>contact form</span>. I’d love to hear from you!
    </div>
    <Footer />
  </div>
</div>
