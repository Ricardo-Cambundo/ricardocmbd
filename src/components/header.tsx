...
const Header = () => {
  ...
  useEffect(() => {
    if (dark) {
      ...
      document.body.style.backgroundColor = "#030712"; // replace with your dark color
    } else {
      // optional: set to default or light background color
  ...
  return (
    ...
    >
      ...
      <div className="header">
        ...
        <ul className={dark ? "menuItemsLight" : "menuItems"}>
          <li
            onClick={() => {
              location.pathname != "/" && navigate("/");
            }}
        ...
        <div className="toggles">
          <div
            className={dark ? "toggleContainer1" :"toggleContainer"}
          ...
          <div
            className={dark ? "toggleContainer1 menuItemsDrop" :"toggleContainer menuItemsDrop"}
            onClick={() => {
              setOpen(!open);
            }}
          >
